...
public class People : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (speechBubbleOb.activeSelf == true)
        {
                ...
                if (Talkmanage.Instance.messageWindow.activeSelf == true)
                {
                    ...
                    {
                        Debug.Log(Talkmanage.Instance.select2.gameObject.activeSelf);
            ...
            if (Playerinput.Instance.Intract.Down)
            {
                ...
                {
                    Debug.Log(Talkmanage.Instance.messageWindow.activeSelf);
    ...
    {
        if (Charactercontrolelr.CCInstance.Getvelocity().x > -2f && Charactercontrolelr.CCInstance.Getvelocity().x < 2f && Charactercontrolelr.CCInstance.Getvelocity().y < 1f)
        {
