...
public class EnemyBehaviour : MonoBehaviour
{
    ...
    private void Start()
        ...
        public void SetFacingData(int facing)
        {
            ...
            {
            facecheck = true;
            skeletonAnimation.skeleton.FlipX = spriteFaceLeft;
    ...
    public void GroundedHorizontalMovement( float speedScale = 1f)
    {
        ...
        rb2d.velocity = new Vector2(m_SpriteForward.x* 5f, 0f);
        Debug.Log("walk");
    ...
    public void Shooting()
        ...
        Vector2 throwVector = new Vector2(8f, 2.0f);
            ...
            throwVector.x = Mathf.Sign(damagerToThis.x) * -11.0f;
        ...
        this.transform.DOShakePosition(0.7f, 1.2f, 20, 1, false, true);
        m_FlickeringCoroutine = StartCoroutine(Flicker(damageable));
            CameraShaker.Shake(0.15f, 0.3f);
        Debug.Log(skeletonAnimation.skeleton.GetColor());
        }
    ...
    protected IEnumerator Flicker(Damagerable damageable)
        {
            ...
            skeletonAnimation.skeleton.SetColor( transparent);
